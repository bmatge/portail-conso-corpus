---
title: "Revente de billets de spectacles ou de compétitions sportives"
nid: 3221937
type: "article_espace"
status: 1
langcode: "fr"
created: "2023-05-23"
changed: "2024-10-28"
alias: "/dgccrf/les-fiches-pratiques-et-les-faq/revente-de-billets-de-spectacles-ou-de-competitions-0"
taxonomy: ["Achat/vente   ", "Prix, promotion, soldes", "Litige", "Sports, loisirs", "Fiche Particuliers", "Fiche pratique"]
menu_path: "Les fiches pratiques et les FAQ > Revente de billets de spectacles ou de compétitions sportives"
source: "dgccrf"
---

# Revente de billets de spectacles ou de compétitions sportives
...
- Réfléchissez bien lors de votre achat, il n’y a généralement pas de droit de rétractation pour les billets achetés, et les conditions générales de vente ne prévoient souvent ni échange ni remboursement.

- La revente de billets s'effectue entre particuliers via des plateformes en ligne, avec des frais facturés aux acheteurs et aux vendeurs.

- Acheter des billets sur le marché de la revente comporte des risques, tels que payer un prix excessif, recevoir des billets falsifiés ou ne pas recevoir de billet du tout.
...
**À retenir : les infractions en matière de faux billets ou la revente de billets à titre habituelle sans autorisation du producteur sont relevées par les services de police et de gendarmerie. Des pré-plaintes peuvent être déposées en ligne : [www.pre-plainte-en-ligne.gouv.fr](http://www.pre-plainte-en-ligne.gouv.fr). **
...
Si vous avez ou pensez avoir rencontré un problème de consommation (défaut d’information sur les prix, clause abusive, publicité trompeuse) avec un professionnel, vous pouvez le signaler en quelques clics sur la plateforme [SignalConso](https://signal.conso.gouv.fr/).

Si vous estimez avoir été victime d’une escroquerie ou pour signaler un revendeur de billet, qui n’en aurait pas le droit : déposez une pré-plainte auprès des services de la police : [www.pre-plainte-en-ligne.gouv.fr](http://www.pre-plainte-en-ligne.gouv.fr).

**Ce que dit la loi :**

- [Loi n° 2004-575 du 21 /06/2004](https://www.legifrance.gouv.fr/loda/id/LEGISCTA000006117685)

- Code de la consommation – articles : [L111-1](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000041598850/)  et [L111-2](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000028747410/2021-02-06/)– [L221-28 – 12e](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000032226820?isSuggest=true)

- [Code pénal – article 313-6-2](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000025492294/)
