---
title: "Bilan 2021/2022 des enquêtes de la DGCCRF dans le secteur des assurances : près d’un tiers des établissements contrôlés en anomalie"
nid: 3222744
...
created: "2023-06-21"
changed: "2024-10-28"
alias: "/dgccrf/actualites/bilan-20212022-des-enquetes-de-la-dgccrf-dans-le-secteur-des-assurances-pres-dun"
taxonomy: ["Contrat, garantie", "Démarchage", "Assurance", "Fiche Particuliers"]
menu_path: "Actualités > Bilan 2021/2022 des enquêtes de la DGCCRF dans le secteur des assurances : près d’un tiers des établissements contrôlés en anomalie"
source: "dgccrf"
---

# Bilan 2021/2022 des enquêtes de la DGCCRF dans le secteur des assurances : près d’un tiers des établissements contrôlés en anomalie

La quasi-majorité des foyers est couverte par au moins un contrat d’assurance (automobile, habitation, santé). Parfois obligatoires pour certains biens (automobile, location…), les assurances constituent une dépense indispensable des ménages. Il est donc important que les assurés soient en mesure de réaliser un choix éclairé avant de s’engager.
...
En cas de difficulté avec un professionnel, les consommateurs peuvent le signaler sur le site ou l’application [SignalConso](https://signal.conso.gouv.fr/). En cas de litige contractuel, les consommateurs pourront prendre l’attache du professionnel concerné et, si aucune solution n’est trouvée, saisir le médiateur de la consommation compétent (les professionnels ont l’obligation de souscrire à ce service).

Le communiqué de presse

[Bilan 2021/2022 des enquêtes de la DGCCRF dans le secteur des assurances : près d’un tiers des établissements contrôlés en anomalie](/files/files/directions_services/dgccrf/presse/communique/2023/cp-dgccrf-bilan-enquetes-secteur-assurances.pdf?v=1687339434) - PDF, 220 Ko

- Vous rencontrez un problème de consommation avec un professionnel ? [Contactez la DGCCRF](/dgccrf/contacter-dgccrf)

- [CP du 21 mars 2023 : résiliation en trois clics des contrats d’assurance](https://presse.economie.gouv.fr/18032023-cp-publication-du-decret-dapplication-de-larticle-17-de-la-loi-du-16-aout-2022-portant-mesures-durgence-pour-la-protection-du-pouvoir-dachat-permettant-la-resiliation-en-trois-clics-des-cont/)
