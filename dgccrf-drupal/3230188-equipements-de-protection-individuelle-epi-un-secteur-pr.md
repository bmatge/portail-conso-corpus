---
title: "Equipements de protection individuelle (EPI) : un secteur présentant des lacunes à l’étiquetage, mais une sécurité des utilisateurs assurée"
nid: 3230188
type: "article_espace"
status: 1
langcode: "fr"
created: "2024-08-05"
changed: "2024-11-08"
alias: "/dgccrf/laction-de-la-dgccrf/les-enquetes/equipements-de-protection-individuelle-epi-un-secteur"
taxonomy: ["Sécurité", "Information sur les produits", "Habillement, équipement de la personne", "Fiche Particuliers", "Fiches Professionnels", "Enquête"]
menu_path: "L'action de la DGCCRF > Les enquêtes > Equipements de protection individuelle (EPI) : un secteur présentant des lacunes à l’étiquetage, mais une sécurité des utilisateurs assurée"
source: "dgccrf"
---

# Equipements de protection individuelle (EPI) : un secteur présentant des lacunes à l’étiquetage, mais une sécurité des utilisateurs assurée
...
Les [équipements de protection individuelle (EPI)](/dgccrf/Publications/Vie-pratique/Fiches-pratiques/Equipement-de-protection-individelle) font partie intégrante du quotidien des consommateurs. En protégeant tout ou partie du corps, ils contribuent à limiter les accidents potentiellement graves. Pour protéger les consommateurs, la DGCCRF vérifie chaque année que ces produits respectent l’ensemble des exigences requises par la législation, permettant ainsi aux utilisateurs de pratiquer leurs activités sans risque.
...
Une attention particulière a été portée aux équipements destinés à la pratique de l’escalade (cordes dynamiques, harnais, casques, baudriers, etc.) ainsi qu’à ceux destinés aux activités d’équilibre ou de sauts dans les airs (casques, sellettes, sangles). Pour ces équipements, les principales anomalies constatées relevaient de lacunes en matière de marquage et d’étiquetage… Cependant, la vérification du matériel utilisé est primordiale avant toute utilisation en conditions réelles. En effet, parmi les équipements d’escalade analysés, une corde dynamique s’est révélée dangereuse car le nombre de chutes en utilisation était supérieur à la valeur mesurée lors des essais, ce qui a justifié le retrait du marché et le [rappel du produit](https://rappel.conso.gouv.fr).
...
Pour signaler un problème avec un professionnel, un commerce, en magasin ou en ligne, la DGCCRF invite les consommateurs à utiliser la [plateforme SignalConso](https://signal.conso.gouv.fr/fr) afin de régler le litige à l’amiable avec le professionnel.

- [SignalConso](https://signal.conso.gouv.fr/fr) pour signaler un problème de consommation

- Fiche pratique : [Qu’est-ce qu’un équipement de protection individuelle (EPI) ? ](/dgccrf/Publications/Vie-pratique/Fiches-pratiques/Equipement-de-protection-individelle)

- Fiche pratique : [Lunettes de soleil : comment choisir la bonne protection ?](/dgccrf/Publications/Vie-pratique/Fiches-pratiques/Lunettes-de-soleil)

- Enquête 2019 : [Contrôle des équipements de protection individuelle (EPI)](/dgccrf/controle-des-equipements-de-protection-individuelle-epi)

- Enquête 2018 : [Équipements de protection individuelle (EPI) : choisissez un produit sûr !](/dgccrf/equipements-de-protection-individuelle-epi-choisissez-un-produit-sur)
