---
title: "Associations : comment appliquer le RGPD ?"
source: "https://www.inc-conso.fr/content/associations-comment-appliquer-le-rgpd"
date: 2020-01-29
description: "[[{\"type\":\"media\",\"view_mode\":\"media_original\",\"fid\":\"13993\",\"attributes\":{\"alt\":\"\",\"class\":\"media-image\",\"height\":\"229\",\"typeof\":\"foaf:Image\",\"width\":\"267\"}}]]Le 25 mai 2018, le règlement (UE) 2016/679 du Parlement européen et du Conseil du 27 avril 2016 (ci-après \"RGPD\") est entré en vigueur. Le RGPD assure une protection des données à caractère personnel (autre terme utilisé : données personnelles) des personnes physiques. Il abroge la directive européenne 95/46/CE sur la protection des données à caractère personnel, qui était en vigueur jusqu'au 24 mai 2018."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T21:57:27.125751"
---
...
![](https://www.inc-conso.fr/sites/default/files/rgpd-associations.png)

Le 25 mai 2018, le [règlement (UE) 2016/679 du Parlement européen et du Conseil du 27 avril 2016](https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016R0679) (ci-après "RGPD") est entré en vigueur. Le RGPD assure une protection des données à caractère personnel (autre terme utilisé : données personnelles) des personnes physiques. Il abroge la directive européenne 95/46/CE sur la protection des données à caractère personnel, qui était en vigueur jusqu'au 24 mai 2018.


La protection des données personnelles est également encadrée en France par [la loi n° 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés.](https://www.legifrance.gouv.fr/affichTexte.do?cidTexte=JORFTEXT000000886460) Elle a été modifiée pour s'adapter aux dispositions du RGPD.



1 - [Je suis une association. Suis-je concernée ? Dois-je appliquer le RGPD ?](#1)

2 - [Le RGPD s’applique-t-il aussi aux fichiers papier ?](#2)

3 - [Combien de temps dois-je conserver les données personnelles ? ](#3)

4 - [Je traite des données sensibles (certificats médicaux…) Quelles sont les conséquences ? ](#3)

5 - [Dois-je demander un consentement à l’adhérent lorsque je traite ses données personnelles ? ](#4)

6 - [Dois-je désigner un Délégué à la Protection des Données (DPO / DPD) ? ](#5)

7 - [Dois-je répertorier toutes les données personnelles que je traite dans un registre des traitements ? ](#6)

8 - [Dois-je informer les adhérents du traitement de leurs données personnelles ? ](#7)

9 - [Comment gérer l’exercice des droits des personnes ? ](#8)

10 - [Quelles mesures de sécurité dois-je mettre en place ? ](#9)

11 - [J’envoie des lettres d'information. Que dois-je mettre en place pour être en conformité ? ](#10)
...
- au
**responsable du traitement**, c’est-à-dire l’association, en tant que personne morale. Car elle détermine les moyens et les finalités du traitement de données personnelles, ET - au
**sous-traitant**, c’est-à-dire l’entreprise ou l’organisme qui va aider l’association dans le traitement des données personnelles (hébergeurs, intégrateurs de logiciels, agences de communication, etc.).

![](/sites/default/files/styles/large/public/picto-a-noter_95.png?itok=_lbD4MjV)
...
![](/sites/default/files/styles/large/public/picto-exemple_61.png?itok=u5-8iCPc)
...
**principe de minimisation des données**. Limitez au maximum la collecte des données personnelles et assurez-vous de ne collecter que les données personnelles strictement nécessaires à l'exercice de votre activité. Ex. il n'est pas nécessaire de demander la date de naissance dans un bulletin de dons.
...
- Suivre les recommandations de la CNIL : la CNIL avait établi des
[recommandations sur les durées de conservation](https://www.cnil.fr/fr/liste-des-normes-et-des-dispenses)(anciennes normes qui n'ont plus de valeur juridique à compter du 25 mai 2018). Il est possible de se référer à ces recommandations, en attendant la production de référentiels RGPD. - Fixation en interne d’une règle de durée de conservation. L'association doit se poser deux questions :
...
![](/sites/default/files/styles/large/public/picto-notre-conseil_78.png?itok=oEqrnvmv)
...
Est en principe interdit, le traitement des données sensibles, sans le consentement explicite des personnes concernées (article 9 du RGPD, [article 6 de la loi "Informatique et Libertés"](https://www.legifrance.gouv.fr/affichTexteArticle.do;jsessionid=F60C0A67364965034624759F75A73F87.tplgfr22s_1?idArticle=LEGIARTI000037822942&cidTexte=LEGITEXT000006068624&dateTexte=20191009)).


Il existe des **exceptions** à l’interdiction de traitement de données sensibles (__ex__ : droit du travail, motifs d’intérêt public important, intérêts vitaux, etc.). Ou bien lorsque l’adhérent a donné explicitement son consentement.


![](https://www.inc-conso.fr/sites/default/files/styles/large/public/picto-notre-conseil_78.png?itok=oEqrnvmv)

[voir la question 5 sur le consentement](#5)).
...
- traitement nécessaire à l’exécution d’un contrat ou à l’exécution de mesures précontractuelles (ex. adhésion à l'associaion, abonnement au journal...),
...
- coopérer avec l’autorité de contrôle (c’est-à-dire la CNIL). Il s’agit de l’organisme chargé de conseiller les entreprises et organismes dans la mise en place du RGPD. Il a aussi un pouvoir de contrôle et de sanctions. Cliquez ici pour en savoir plus sur
[les missions de la CNIL.](https://www.cnil.fr/fr/les-missions-de-la-cnil)
...
La CNIL propose sur son site internet un [modèle de registre des traitements](https://www.cnil.fr/fr/la-cnil-publie-un-nouveau-modele-de-registre-simplifie), pouvant être téléchargé pour être complété (fichier en format Excel).
...
[voir la question 9 sur l’exercice des droits](#9)).

Le site de la CNIL donne un [exemple de mentions d’informations](https://www.cnil.fr/fr/exemples-de-formulaire-de-collecte-de-donnees-caractere-personnel).
...
![]() Ces informations essentielles ne préjugent pas des règles appliquées par vos instances nationales et fédérations. Référez-vous à ces dernières pour toute question concernant l'application du RGPD. |


**TEXTES DE LOIS**

> [Règlement (UE) 2016/679 du 27 avril 2016](https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016R0679) relatif à la protection des personnes physiques à l'égard du traitement des données à caractère personnel et à la libre circulation de ces données, et abrogeant la directive 95/46/CE (règlement général sur la protection des données).

> [Loi n° 78-17 du 6 janvier 1978](https://www.legifrance.gouv.fr/affichTexte.do?cidTexte=JORFTEXT000000886460) relative à l'informatique, aux fichiers et aux libertés.


![](/sites/default/files/styles/large/public/picto_en-savoir-plus_43.png?itok=uHoWGo10)


> La fiche pratique INC ["RGPD" : quelle protection pour vos données personnelles ?](/content/rgpd-quelle-protection-pour-vos-donnees-personnelles)"

> L'article "[Loi Informatique et Libertés : adaptation de la loi au Règlement Général sur la Protection des Données (RGPD)" ](/content/loi-informatique-et-libertes-adaptation-de-la-loi-au-reglement-general-sur-la-protection-des)"
