---
title: "Délais de réflexion - Délais de rétractation"
source: "https://www.inc-conso.fr/content/delais-de-reflexion-delais-de-retractation-0"
date: 2019-05-16
description: "[[{\"type\":\"media\",\"view_mode\":\"media_original\",\"fid\":\"12949\",\"attributes\":{\"alt\":\"\",\"class\":\"media-image\",\"height\":\"214\",\"typeof\":\"foaf:Image\",\"width\":\"252\"}}]]En principe, votre accord vous engage."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T23:24:13.256824"
---
...
![](https://www.inc-conso.fr/sites/default/files/delais-reflexion_252_1.png)

C'est pourquoi la loi vous protège en vous accordant, selon les domaines, un délai de réflexion ou de rétractation.

Cette fiche pratique de l'Institut national de la consommation vous informe sur les situations dans lesquelles vous bénéficiez d'un tel droit et sur les modalités pour exercer ce droit.


1 - [Qu'est-ce que le délai de réflexion ou de rétractation ?](#1)

2 - [Quelles sont les modalités d'exercice du droit ?](#2)

3 - [Tableau récapitulatif des dispositions relatives aux délais](#Tableau)

4 - [Infographie des principaux délais](#Infographie)



1 - QU'EST-CE QUE LE DELAI DE REFLEXION OU DE RETRACTATION ?

![](https://www.inc-conso.fr/sites/default/files/picto-bon-a-savoir_33.png)

[article 1122 du code civil](https://www.legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006436171&cidTexte=LEGITEXT000006070721) : "La loi ou le contrat peuvent prévoir un délai de réflexion, qui est le délai avant l'expiration duquel le destinataire de l'offre ne peut manifester son acceptation ou un délai de rétractation, qui est le délai avant l'expiration duquel son bénéficiaire peut rétracter son consentement".
...
![](https://www.inc-conso.fr/sites/default/files/picto_attention_14.png)

**Vous ne bénéficiez pas toujours du droit de ****changer d’avis** ! Ce n’est pas un principe général. Vous bénéficiez de ce droit :

- dans les cas prévus par la loi (
[voir le tableau récapitulatif](#Tableau)), - si le professionnel vous accorde lui-même un délai de rétractation (par exemple, s’il pratique le "satisfait ou remboursé").

![](https://www.inc-conso.fr/sites/default/files/picto_attention_14.png)

**exceptions**. Il est par exemple exclu pour la "fourniture de biens confectionnés selon les spécifications du consommateur ou nettement personnalisés" ([article L. 221-28 du code de la consommation](http://www.legifrance.gouv.fr/affichCodeArticle.do?cidTexte=LEGITEXT000006069565&idArticle=LEGIARTI000032221387&dateTexte=&categorieLien=cid)). ou pour les achats effectués dans les foires et salons ([article L. 224-59 du code de la consommation](https://www.legifrance.gouv.fr/affichCodeArticle.do?cidTexte=LEGITEXT000006069565&idArticle=LEGIARTI000032221605&dateTexte=&categorieLien=cid)).


> Pour en savoir plus sur l'absence de droit de rétractation dans les foires et salons, consultez l'actualité de l'INC "[Foires et salons : pas de droit de rétractation](https://www.inc-conso.fr/content/foires-et-salons-pas-de-droit-de-retractation)".
...
> Pour en savoir plus, voir la partie "[Crédit à la consommation - Crédit immobilier](/sites/default/files/tableau_delais_reflexion_1.pdf)" du tableau.



![](https://www.inc-conso.fr/sites/default/files/picto-notre-conseil_23.png)


> Voir la rubrique "Puis-je changer d’avis et retourner ma commande" sur la fiche de l'INC "[Acheter sur internet en 10 questions-réponses](https://www.inc-conso.fr/content/acheter-sur-internet-en-10-questions-reponses)".
...
![](https://www.inc-conso.fr/sites/default/files/picto-exemple_17.png)
...
**date d’envoi** de la **demande** de rétractation et non pas la date de réception de la rétractation qui est prise en compte. Attention : en cas de contestation, **ce sera à vous de prouver **que vous avez effectué votre rétractation dans les formes et délais prévus par la loi.


> Pour en savoir plus sur le calcul des délais, consultez l'article de l'INC "[Jours ouvrables, jours chômés, jours fériés. Comment les identifier ?](https://www.inc-conso.fr/content/jours-ouvrables-jours-chomes-jours-feries-comment-les-identifier)".
...
4 - INFOGRAPHIE DES PRINCIPAUX DELAIS


![](https://www.inc-conso.fr/sites/default/files/delai-reflexion-retractation-inc-2019_1.png)




> Reportez-vous au [tableau](#Tableau) pour connaître le point de départ de chaque délai.



**Pour en savoir plus, vous pouvez :**

> Prendre contact avec [une association agréée de consommateurs](/content/les-associations-de-consommateurs) si vous souhaitez obtenir des informations complémentaires ou si vous rencontrez des difficultés

> Vous adresser aux [agents de la Direction générale de la concurrence, de la consommation et de la répression des fraudes](http://www.economie.gouv.fr/dgccrf/coordonnees-des-DDPP-et-DDCSPP) (DGCCRF) du département dans lequel se situe le professionnel.
