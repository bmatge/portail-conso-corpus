---
title: "La Médiatrice des communications électroniques a présenté son rapport annuel 2024"
source: "https://www.inc-conso.fr/content/la-mediatrice-des-communications-electroniques-presente-son-rapport-annuel-2024"
date: 2025-02-20
description: "Madame Valérie Alvarez, Médiatrice des communications électroniques, a présenté, le 13 février 2025, son rapport d'activité pour l'année 2024. Celui-ci dresse le bilan de l’année 2024 et fait part des diverses recommandations adressées aux opérateurs. Elle présente également 8 recommandations à l’attention des consommateurs et 7 cas concrets soumis à la médiation des communications électroniques. Cette année, la Médiatrice présente également 4 cas déclarés irrecevables."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T23:12:47.901546"
---
...
Madame Valérie Alvarez, Médiatrice des communications électroniques, a présenté, le 13 février 2025, son [rapport d'activité pour l'année 2024](https://rapportannuel2024.mediation-telecom.org/). Celui-ci dresse le bilan de l’année 2024 et fait part des diverses recommandations adressées aux opérateurs.


Elle présente également [8 recommandations](https://rapportannuel2024.mediation-telecom.org/recommandations.php) à l’attention des consommateurs et [7 cas concrets](https://rapportannuel2024.mediation-telecom.org/exemples.php) soumis à la médiation des communications électroniques. Cette année, la Médiatrice présente également [4 cas déclarés irrecevables](https://rapportannuel2024.mediation-telecom.org/exemples.php).


![La Médiatrice des communications électroniques](https://www.inc-conso.fr/sites/default/files/mediatrice-communication-800_0.png)
...
A noter : La durée de traitement des dossiers a augmenté en 2024 (**93 jours**) contre 72 en 2023. Bien que ce délai soit supérieur à la** limite des 90 jours** imposée par l’[article R. 612-15 du code de la consommation](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000032808336#:~:text=L'issue%20de%20la%20m%C3%A9diation,en%20avise%20imm%C3%A9diatement%20les%20parties.), cette latitude est permise en cas de litige complexe (ce qui fut notamment le cas dans le domaine de la fibre). Il s’explique également par l’absence de réponse, de réponse incomplète et/ou tardives par certains professionnels pour répondre aux sollicitations de la Médiatrice.
...
Les conditions et le processus permettant le recours à la médiation ne sont pas respectés (voir [processus de saisine de la Médiatrice par le consommateur](https://www.mediation-telecom.org/saisir-le-mediateur)) : voies de recours non épuisées (74 %), traitement en cours auprès du service consommateurs (8 %), pas de lien contractuel (6 %), litige professionnel (5 %), hors champ de compétence (6 %) et divers (1 %).
...
Cela démontre qu’il n’avait pas lu les informations sur le site de la médiation lui précisant le [parcours pour sa saisine](https://www.mediation-telecom.org/saisir-le-mediateur), ni répondu de façon correcte aux questions du [quizz en ligne](https://www.mediation-telecom.org/quizz), qui permet de vérifier que la Médiatrice peut juger son dossier recevable, ni lu le courrier d’irrecevabilité qui lui a été adressé.


**Processus permettant la saisine de la Médiatrice par le consommateur**


![](https://www.inc-conso.fr/sites/default/files/niveau_1_service_clients_de_loperateur_1.png)
...
> Pour vous aider dans votre démarche, utilisez le modèle de lettre de l'INC " |
