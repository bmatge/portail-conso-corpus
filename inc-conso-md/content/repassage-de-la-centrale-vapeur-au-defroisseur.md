---
title: "Repassage : de la centrale vapeur au défroisseur"
source: "https://www.inc-conso.fr/content/repassage-de-la-centrale-vapeur-au-defroisseur"
date: 2016-05-04
description: "[[{\"type\":\"media\",\"view_mode\":\"media_original\",\"fid\":\"5871\",\"attributes\":{\"alt\":\"\",\"class\":\"media-image\",\"height\":\"227\",\"typeof\":\"foaf:Image\",\"width\":\"267\"}}]]Pour beaucoup, repasser du linge est une véritable corvée. Les centrales vapeur, fers et autres défroisseurs promettent, arguments marketing à la clé, de faire du repassage un jeu d’enfant, à la fois en gagnant du temps et en obtenant un résultat impeccable. Autonomie, fonctionnement, capacité du réservoir, encombrement… : avant d’acheter un appareil, mieux vaut connaître ses spécificités. Le point sur les différentes technologies."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T23:44:34.802573"
---
...
![](https://www.inc-conso.fr/sites/default/files/fer_vapeur-252.jpg)
...
|
- Un bon compromis entre poids et légèreté : plus la semelle sera lourde, plus le repassage sera efficace, mais moins l’utilisateur appréciera de manipuler l’appareil à la longue !
|
|
- Une bonne répartition de la chaleur sur toute sa surface ;
|
|
- Un agencement et un nombre de trous de sortie de vapeur optimum. Les principaux fabricants travaillent à développer des semelles optimisant l’agencement des zones de sortie vapeur et des zones de chauffe pour améliorer l’efficacité de repassage ;
|
|
- Un revêtement conjuguant à la fois de bonnes propriétés de glisse et une bonne résistance aux rayures. Il doit être, de plus, facilement nettoyable pour éliminer aisément les fibres ou salissures venant encrasser à la longue la surface.
|
|
- Une forme qui allie une géométrie permettant l’atteinte des zones étroites (par exemple entre les boutons d’une chemise) et un large corps sans bords saillants évitant la formation des plis lors des allés/retours.
**La présence d’une encoche en tête de fer**permettra de passer facilement au plus près de la couture du bouton sans risque de l’arracher.
|
|



**La vapeur, dispositif central**
...
|
Défroisseur vertical à réservoir illimitée
|
Défroisseur vertical compact
|
![]() |
![]() |
