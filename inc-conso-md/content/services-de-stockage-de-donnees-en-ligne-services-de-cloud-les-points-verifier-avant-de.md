---
title: "Services de stockage de données en ligne (services de cloud) : les points à vérifier avant de souscrire"
source: "https://www.inc-conso.fr/content/services-de-stockage-de-donnees-en-ligne-services-de-cloud-les-points-verifier-avant-de"
date: 2021-05-06
description: "[[{\"type\":\"media\",\"view_mode\":\"media_original\",\"fid\":\"18191\",\"attributes\":{\"alt\":\"\",\"class\":\"media-image\",\"height\":\"227\",\"typeof\":\"foaf:Image\",\"width\":\"267\"}}]]Vous recherchez une solution pour stocker en ligne vos photos, votre musique, des documents personnels ? Le service de stockage en ligne est une solution."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T22:03:16.418669"
---
...
![](https://www.inc-conso.fr/sites/default/files/clound-2-252.png)
...
1 - [Qu’est-ce qu’un service de stockage de données en ligne/service de cloud ?](#1)

2 - [Quels types de contrats sont proposés par les services de stockage de données en ligne ?](#2)

3 - [Disposez-vous d’un droit de rétractation après souscription du contrat "cloud" ?](#3)

4 - [Comment s’assurer de la protection de vos données à caractère personnel ?](#4)

5 - [Qu’est-ce que le chiffrement de bout en bout ?](#5)

6 - [Pouvez-vous choisir le lieu d’hébergement de vos données ?](#6)

7 - [Les contenus stockés sont-ils immédiatement effacés après la fermeture du compte ?](#7)

9 - [Est-il possible de changer de cloud/de service de stockage de données en ligne ?](#9)


|
- Lire les politiques de confidentialité / politique de protection des données (selon la dénomination) et les conditions d’utilisation.
...
- Connaître les droits que vous pouvez exercer : droits d’accès, de suppression… de vos données à caractère personnel à tout moment.
|
...
Ces services sont pratiques car ils ont une grande capacité de stockage (plusieurs Go jusqu’à plusieurs To), ce qui peut être utile lorsque l’espace de stockage physique dont dispose l'utilisateur n’est pas suffisant ([Définition des octets : ko, Mo, Go, To...)](https://www.futura-sciences.com/tech/definitions/informatique-octet-585/).
...
Le droit de rétractation doit être exercé dans les 14 jours à compter du lendemain de la conclusion du contrat (article [L. 221-18](https://www.legifrance.gouv.fr/affichCodeArticle.do;jsessionid=0F39BF87BE30F6A79C692005C16CF71B.tpdila11v_3?idArticle=LEGIARTI000032226842&cidTexte=LEGITEXT000006069565&dateTexte=20170509) et [L. 221-19](https://www.legifrance.gouv.fr/affichCodeArticle.do;jsessionid=0F39BF87BE30F6A79C692005C16CF71B.tpdila11v_3?idArticle=LEGIARTI000032226840&cidTexte=LEGITEXT000006069565&dateTexte=20170509&categorieLien=id&oldAction=&nbResultRech=) du code de la consommation)


![](https://www.inc-conso.fr/sites/default/files/picto_en-savoir-plus_54.png)


[La vente hors établissement (ou "démarchage à domicile")](/content/la-vente-hors-etablissement-ou-demarchage-domicile).[Délais de réflexion - Délais de rétractation](/content/delais-de-reflexion-delais-de-retractation).
...
- Quelles sont les finalités des données à caractère personnel collectées (par exemple sont-elles utilisées à des fins commerciales) ? Quels en sont les destinataires (entreprises commerciales …) ?
...
- Est-il possible d’exercer ses droits sur ses données à caractère personnel (droit d’accès, de rectification, de suppression, …) ?
|


Le [Règlement Général sur la Protection des Données à caractère personnel](https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016R0679) (dit "RGPD") et [la loi Informatique et Libertés](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000000886460/) sont les deux textes de loi encadrant, en France, la protection des données à caractère personnel.
...
![](/sites/default/files/picto_attention_131.png)
...
Pour en savoir plus sur les différents niveaux de protection des données dans le monde,[ consultez la carte « La protection des données dans le monde » de la CNIL](https://www.cnil.fr/fr/la-protection-des-donnees-dans-le-monde).
...
![](https://www.inc-conso.fr/sites/default/files/picto-a-noter_97_0.png)
...
L’information sur la récupération des données n’est pas une obligation qui incombe aux professionnels au sens du droit de la consommation. Il faut se référer au Règlement Général sur la Protection des Données ([RGPD](https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016R0679)) qui garantit aux utilisateurs notamment un droit d’accès à leurs données et un droit à l’effacement.


La CNIL a publié des [recommandations relatives aux services de stockages de données en ligne](https://www.cnil.fr/sites/default/files/typo/document/Recommandations_pour_les_entreprises_qui_envisagent_de_souscrire_a_des_services_de_Cloud.pdf) en 2012. A l’occasion de cette publication, elle a pu considérer par exemple que l’un des risques les plus importants pour l’exploitation d’un cloud est la* "fermeture du service du prestataire".* La CNIL a rappelé la nécessité de prévoir une clause relative à la destruction et à la restitution des données.
...
![](/sites/default/files/notre-conseil.png)
...
> Fiche pratique INC "["RGPD" : quelle protection pour vos données personnelles ?](/content/rgpd-quelle-protection-pour-vos-donnees-personnelles)".


> Fiche pratique INC "[La vente hors établissement (ou "démarchage à domicile")](/content/la-vente-hors-etablissement-ou-demarchage-domicile)".


> Fiche pratique INC "[Délais de réflexion - Délais de rétractation](/content/delais-de-reflexion-delais-de-retractation)".


> Article 60 Millions de consommateurs "[Comparatif de services de stockage en ligne](https://www.60millions-mag.com/kiosque/pizza-burger-raclette-peut-craquer)"[ ](https://www.60millions-mag.com/kiosque/pizza-burger-raclette-peut-craquer)**(contenu payant)** - Mensuel - N° 566 - 02/2021.
