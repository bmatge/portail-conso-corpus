---
title: "Troubles anormaux de voisinage : actualités !"
source: "https://www.inc-conso.fr/content/troubles-anormaux-de-voisinage-actualites"
date: 2024-04-19
description: "Les troubles de voisinage sont souvent au cœur de l'actualité. Cette notion est encadrée par la jurisprudence, mais également par un nouvel article du code civil depuis le 17 avril 2024. L'Institut national de la consommation vient faire le point sur la notion juridique de \"troubles anormaux de voisinage\", qui a fait l'objet de récentes modifications et/ou précisions."
tags: "['INC-Conso']"
scraped_at: "2026-02-24T23:04:02.547296"
---
...
![](https://www.inc-conso.fr/sites/default/files/troubles-voisinage-800.png)



### 1 - L'entrée de la définition du trouble anormal de voisinage dans le Code civil

La [loi n° 2024-346 du 15 avril 2024](https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000049418434) visant à adapter le droit de la responsabilité civile aux enjeux actuels est constituée d'un seul article.
...
Pour répondre à ce constat, la loi vient créer un nouvel article au sein du code civil. Il s'agit de l'[article 1253](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000049423788/2024-04-28), inséré d'un chapitre 4 intitulé "Les troubles anormaux de voisinage". Ce texte vient consacrer les positions adoptées par les tribunaux en cette matière.
...
```
En savoir plus :
```[Cour de cassation, civile, Chambre civile 3, 14 mars 2024, 19-21.361](https://www.legifrance.gouv.fr/juri/id/JURITEXT000049321384?page=1&pageSize=10&query=%22trouble+anormal+de+voisinage%22&searchField=ALL&searchType=ALL&sortValue=DATE_DESC&tab_selection=juri&typePagination=DEFAULT)
...
```
En savoir plus :
```[Cour de cassation, civile, Chambre civile 3, 25 mai 2023, 22-15.453](https://www.legifrance.gouv.fr/juri/id/JURITEXT000047635936?page=1&pageSize=10&query=%22trouble+anormal+de+voisinage%22&searchField=ALL&searchType=ALL&sortValue=DATE_DESC&tab_selection=juri&typePagination=DEFAULT)
...
```
En savoir plus :
```[Cour de cassation, civile, Chambre civile 3, 1 mars 2023, 21-19.716](https://www.legifrance.gouv.fr/juri/id/JURITEXT000047268990?page=2&pageSize=10&query=%22trouble+anormal+de+voisinage%22&searchField=ALL&searchType=ALL&sortValue=DATE_DESC&tab_selection=juri&typePagination=DEFAULT)
...
Pour en savoir plus : [JO Débats parlementaires Questions-Réponses Assemblée nationale (assemblee-nationale.fr)](https://questions.assemblee-nationale.fr/static/16/questions/jo/jo_anq_202340.pdf) (page 8824)
