---
date: 2018-09-26
description: En effet, de nos jours, avec l'arrivée de l'électronique, il suffit de
  capter un signal pour ouvrir une portière ou d'installer un boîtier sur l'ordinateur
  central de la voiture pour démarrer le véhicule.
scraped_at: '2026-02-24T21:48:11.713972'
source: https://www.inc-conso.fr/content/assurance-automobile-le-vol-sans-effraction
tags:
- INC-Conso
title: 'Assurance automobile : le vol sans effraction'
---
...
Les vols (ou tentatives de vol) de voitures représentent [49 000 déclarations des ménages en France en 2016](https://www.interieur.gouv.fr/Interstats/Themes/Vols-lies-aux-vehicules/Chiffres-cles-Vols-ou-tentatives-de-vols-de-vehicules-declares-par-les-menages).
...
1 - [Les conditions du vol prévues dans les contrats d'assurance ](#conditions)

2 - [C'est à l'assuré de rapporter la preuve du dommage, mais la preuve est libre ](#preuve)

3 - [Limiter les moyens de preuve s'apparente à une clause abusive ](#clauseabusive)

4 - [Exemples jurisprudentiels de faisceaux d'indices permettant de prouver le vol du véhicule ](#exemples)

5 - [Que faire en cas de litige ? ](#litigtes)
...
- Véhicule déplacé dans la nuit (
[CA Nancy, 1](http://www.doctrine.fr/d/CA/Nancy/2017/C9315E2A6EAAE03D8E825)).èreCh., 6 février 2017 RG n° 16/00157

- Découverte d’un véhicule abandonné sur la voie publique et non pas à l’endroit où il était déclaré garé (
[CA Montpellier, 1](https://www.doctrine.fr/d/CA/Montpellier/2017/CB45811294DFBA79F8968)) :èreCh. B, 1erfévrier 2017, RG n° 14/01560*"le véhicule a été récupéré par la fourrière, dans des conditions indéterminées qui ne permettent donc pas de rejeter la réalité d’un déplacement du véhicule et donc d’un vol, les constatations opérées unilatéralement et dans un délai variant entre trois mois et deux ans ne permettant pas d’opposer à l’assuré l’absence de traces matérielles de vol, ou a fortiori une fausse déclaration'",*

- Déplacement certain du véhicule qui implique une effraction de la colonne de direction par un biais électronique (
[CA Montpellier, 1](https://www.lextenso.fr/jurisprudence/CAMONTPELLIER-10012017-14_00872)) : "l'assuré démontre l'effraction de la colonne de direction du véhicule, le contrat ne permettant pas de lui opposer la nécessité du caractère mécanique de cette effraction, et la démonstration étant suffisante par cet assuré non seulement de la soustraction frauduleuse de son véhicule, mais aussi du contournement du blocage de sa direction puisque le véhicule a été déplacé de plusieurs kilomètres, nécessairement par un procédé électronique".èreCh. B, 10 janvier 2017, RG n° 14/00872

- Véhicule calciné et ne comportant qu’un seul barillet sur la porte avant gauche. Si ce barillet, l’antivol de direction et la colonne de direction ne comportaient pas des traces visibles d’effraction, les vitres du véhicule avaient disparu du fait de l’incendie, de telle sorte que personne ne peut exclure que l’une d’elle ait été brisée (
[CA Versailles, 3](https://www.lextenso.fr/jurisprudence/CAVERSAILLES-02112017-15_09035)).èmechambre, 2 novembre 2017, RG n° 15/09035
...
Vous pouvez également vous faire assister par une [association nationale de consommateurs agréée](https://www.inc-conso.fr/content/trouvez-lassociation-de-consommateurs-la-plus-proche-de-chez-vous).
