---
date: 2017-12-06
description: Jusqu'à une époque récente, l'innovation était presque exclusivement
  le fait des organismes d'assurance eux-mêmes, que ce soit sociétés d'assurances
  ou intermédiaires, quelquefois prestataires. Avec le développement d'Internet, ce
  champ s'est élargi et de nombreux acteurs imaginatifs sont aujourd'hui en mesure
  de contribuer au renouvellement de cette activité. Par exemple, les comparateurs
  d'assurances peuvent être amenés à prendre une part croissante dans la distribution.
  De nouvelles formes d'assurances peuvent être imaginées (peer to peer, assurance
  à la demande...).
scraped_at: '2026-02-24T23:24:49.488430'
source: https://www.inc-conso.fr/content/assurance-et-conso-collaborative-vers-le-developpement-de-produits-specifiques
tags:
- INC-Conso
title: 'Assurance et Conso-Collaborative : vers le développement de produits spécifiques
  ?'
---
...
Ce document fait suite au colloque organisé par l'INC sur la consommation collaborative le 7 novembre 2014 ([voir le dossier sur le colloque](/content/consommation-collaborative)).

![](/sites/default/files/galerie/galimages/Images%20diverses/internet_reseaux_252.jpg)
...
Cependant très vite des questions se posent : quelle définition de la consommation collaborative retenir de la part de l'assureur quant à l'objet du risque à assurer ? Celle du Comité économique et social européen dans son [avis du 21 janvier 2014](http://eur-lex.europa.eu/legal-content/FR/TXT/PDF/?uri=CELEX:52013IE2788&from=FR) ? Ou, et c'est sûrement cette conception qui l'emporte pour l'assureur, une définition plus technique qui englobe les différentes opérations juridiques intervenant dans l'opération de consommation collaborative : l'échange, la location voire la vente, ce qui permet une segmentation plus fine du risque à assurer.
...
I - [Des produits d'assurances traditionnels hors-jeu ?](#Produits)

A - [La couverture responsabilité civile "chef de famille" de la MRH inadaptée](#couverture)

B - [Des évolutions techniques possibles](#évolutions)

II - [Les précautions à prendre quant aux nouvelles solutions de marché](#Précuations)

A - [Les étapes essentielles de la souscription d'un nouveau contrat d'assurance adapté](#étapes)

1- [Quelle activité est réellement couverte par le contrat ?](#étapes)

2 - [Quelle est la période de couverture ?](#période)

3 - [Quelles sont les questions, présentes dans le formulaire de déclaration des risques, qui ont été posées ?](#questions)
...
L'exécution intégrale n'est pas définie par les textes et la jurisprudence a uniquement indiqué que le versement immédiat de la prime à l'assureur par l'assuré ainsi que la prise d'effet immédiate de la couverture ne suffisent pas à caractériser cet élément (Cass. civ. II, 17 janvier 2013, [n° 11-20155](http://www.legifrance.gouv.fr/affichJuriJudi.do?oldAction=rechJuriJudi&idTexte=JURITEXT000026959429&fastReqId=1395207604) Cass. civ. II, 17 janvier 2013, [n° 11-28928](http://www.legifrance.gouv.fr/affichJuriJudi.do?oldAction=rechJuriJudi&idTexte=JURITEXT000026959411&fastReqId=1076611656)).
...
( articles [R. 113-11](http://www.legifrance.gouv.fr/affichCodeArticle.do;jsessionid=DF034D532F93DD2E9844B53E209B491B.tpdila14v_1?idArticle=LEGIARTI000030043729&cidTexte=LEGITEXT000006073984&dateTexte=20150220) et [R.113-12-1](http://www.legifrance.gouv.fr/affichCodeArticle.do;jsessionid=DF034D532F93DD2E9844B53E209B491B.tpdila14v_1?idArticle=LEGIARTI000030043731&cidTexte=LEGITEXT000006073984&dateTexte=20150220&categorieLien=id&oldAction=&nbResultRech=) du code des assurances.Les assurances vendues en complément de la vente d'un bien ou d'un service sont concernées.
