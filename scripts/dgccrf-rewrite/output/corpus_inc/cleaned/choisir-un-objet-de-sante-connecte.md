---
date: 2016-01-13
description: Vous êtes de plus en plus nombreux à acheter des objets connectés qui
  vous permettent de surveiller votre poids, mesurer vos efforts physiques, des paramètres
  physiologiques tels que votre tension, votre rythme cardiaque, etc. Ces objets sont
  connectés via votre smartphone ou directement sur le web. En bref, vous souhaitez
  acheter un tel objet et utiliser l’application associée pour votre santé, votre
  bien-être.
scraped_at: '2026-02-24T23:41:20.211021'
source: https://www.inc-conso.fr/content/choisir-un-objet-de-sante-connecte
tags:
- INC-Conso
title: Choisir un objet de santé connecté
---
...
1 - [L’objet, la connectique et le contenu de l’application](#1)

2 - [Le fournisseur de l’objet et l’éditeur de l’application](#2)

3 - [La protection de vos données personnelles](#3)
