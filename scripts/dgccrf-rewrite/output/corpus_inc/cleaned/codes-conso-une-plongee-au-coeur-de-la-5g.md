---
date: 2021-09-07
description: 'Episode 8 : Codes Conso "Une plongée au cœur de la 5G" Si le player
  ne s''affiche pas correctement, cliquez ici. Aujourd’hui, je vous propose une plongée
  au cœur de la 5G et de son encadrement. Depuis fin 2020, les plus gros opérateurs
  téléphoniques ont tous activé cette 5ème génération de réseau mobile dans les grandes
  villes de France.'
scraped_at: '2026-02-24T22:04:47.852433'
source: https://www.inc-conso.fr/content/codes-conso-une-plongee-au-coeur-de-la-5g
tags:
- INC-Conso
title: Codes Conso "Une plongée au cœur de la 5G"
---
...
Si le player ne s'affiche pas correctement, [cliquez ici](/content/codes-conso-une-plongee-au-coeur-de-la-5g).

Aujourd’hui, je vous propose une plongée au cœur de la 5G et de son encadrement. Depuis fin 2020, les plus gros opérateurs téléphoniques ont tous activé cette 5ème génération de réseau mobile dans les grandes villes de France.
...
Tous les résultats de nos contrôles sont publiés en open-data (c’est-à-dire) sur le site [data.anfr.fr](http://data.anfr.fr) et les cas de non-conformité font systématiquement l’objet d’un communiqué de presse et sont relayés sur nos réseaux sociaux, pour informer les détenteurs des téléphones concernés.
...
On a un site dédié pour cela : [mesures.anfr.fr](http://mesures.anfr.fr)

On remplit un formulaire CERFA qui doit être validé par un organisme habilité (exemple une mairie).

Les mesures sont réalisées par un laboratoire accrédité COFRAC pour réaliser ces mesures selon le protocole établi par l’ANFR. Le résultat est ensuite envoyé au demandeur et rendu public sur le site [cartoradio.fr](http://cartoradio.fr).
