---
date: 2024-03-20
description: Lorsqu’un professionnel refuse de vous vendre un bien en tant que consommateur
  ou une prestation de service, il faut savoir que ce comportement est interdit par
  la loi. L’article L121-11 du code de la consommation énonce qu’il est "interdit
  de refuser à un consommateur la vente d’un produit ou la prestation d’un service".
  Ainsi, en principe, personne ne peut se voir opposer un refus de vente. En principe,
  car le refus de vente s’apprécie au cas par cas. Il faut savoir que le refus de
  vente ou de prestation de service est admis dès lors que le professionnel invoque
  un motif légitime.
scraped_at: '2026-02-24T23:03:02.402401'
source: https://www.inc-conso.fr/content/comment-agrir-face-un-refus-de-vente-ou-de-prestation-de-service-avec-familles-de-france
tags:
- INC-Conso
title: Comment agrir face à un refus de vente ou de prestation de service ? avec Familles
  de France
---
...
A défaut, signaler le refus de vente à la DGCCRF, via la plateforme [SignalConso](https://signal.conso.gouv.fr/fr). Cela pourra éventuellement permettre de constater l’infraction, voire d’imposer au vendeur de cesser ses pratiques. Le dossier de signalement et l’enquête pourront éventuellement être transmis au Parquet.

Et sachez que vous pouvez saisir le [Défenseur des droits](https://www.defenseurdesdroits.fr/) pour les refus liés à la discrimination, via le site [antidiscriminations.fr](http://www.antidiscriminations.fr). Des conseils d’un juriste peuvent être sollicités au 3928, prix d’un appel local.