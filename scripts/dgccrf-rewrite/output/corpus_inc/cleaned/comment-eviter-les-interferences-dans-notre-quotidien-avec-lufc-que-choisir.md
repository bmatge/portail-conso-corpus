---
date: 2024-11-21
description: 'Beaucoup de gestes de la vie quotidienne sont possibles grâce aux ondes
  : passer un appel depuis un portable,consulter la météo,regarder la télévision par
  la TNT… ConsoMag, aujourd’hui, fait un focus sur ce qui est légal ou non de faire,
  par rapport aux ondes, et vous donne des conseils pratiques pour éviter les interférences.
  Pour commencer, penchons-nous sur les répéteurs, ces boitiers qui amplifient et
  rediffusent le signal. Certains sont légaux, et d’autres non. Les répéteurs Wi-Fi,
  utilisés pour améliorer la couverture du signal Internet dans son logement, sont
  autorisés.'
scraped_at: '2026-02-24T23:10:09.086234'
source: https://www.inc-conso.fr/content/comment-eviter-les-interferences-dans-notre-quotidien-avec-lufc-que-choisir
tags:
- INC-Conso
title: Comment éviter les interférences dans notre quotidien ? avec l'UFC-Que choisir
---

# Comment éviter les interférences dans notre quotidien ? avec l'UFC-Que choisir
...
- passer un appel depuis un portable,
- consulter la météo,
- regarder la télévision par la TNT…
...
[L’agence nationale des fréquences](https://www.anfr.fr/accueil) est chargée de traquer ceux qui utilisent ces appareils, mais aussi, de manière plus générale, tout ce qui perturbe le spectre radioélectrique. Et chacun peut être concerné.
