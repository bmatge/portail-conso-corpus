---
date: 2024-10-30
description: '"Un manque de lisibilité globale des informations précontractuelles
  fournies aux souscripteurs sur le fonctionnement de ces contrats", c''est le constat
  effectué par le Comité consultatif du secteur financier (CCSF) à la suite d''une
  analyse de contrats d''assurance obsèques.'
scraped_at: '2026-02-24T23:09:04.404797'
source: https://www.inc-conso.fr/content/assurance/contrats-dassurance-obseques-pour-une-meilleure-lisibilite-et-un-renforcement-des-garanties
tags:
- INC-Conso
title: 'Contrats d’assurance obsèques : pour une meilleure lisibilité et un renforcement
  des garanties'
---
...
L'[avis](/sites/default/files/pdf/ccsf_avis_contrats_obseques.pdf) présente :
...
*Source : Fédération nationale du funéraire *

*Source : Secrétariat du CCSF, à partir des chiffres de France Assureurs et des Fédérations d'opérateurs funéraires *

> [Lire le communiqué de presse du CCSF](/sites/default/files/pdf/ccsf_avis_contrats_obseques_cp.pdf)

> [Lire l'avis du CCSF](/sites/default/files/pdf/ccsf_avis_contrats_obseques.pdf)

> [En savoir plus sur le CCSF](https://www.ccsfin.fr/news/communique-de-presse)