---
date: 2024-06-10
description: 'Le compte que vous avez ouvert auprès de votre banque est un compte
  de dépôt à vue. Les opérations que vous effectuez (retraits, versements, paiements...)
  sont enregistrées sur celui-ci et ont pour conséquence de diminuer ou d''augmenter
  le solde du compte : ce dernier doit nécessairement être créditeur (c''est-à-dire
  "positif"). Toutefois, vous pouvez rencontrer des difficultés financières, et avoir
  besoin d''un découvert bancaire. L''utilisation du découvert est largement admise
  dans l''ensemble des établissements bancaires.'
scraped_at: '2026-02-24T22:02:42.308301'
source: https://www.inc-conso.fr/content/etudiants-tout-savoir-sur-le-decouvert-bancaire
tags:
- INC-Conso
title: 'Etudiants : tout savoir sur le découvert bancaire'
---
...
1 - [Comment fonctionne un découvert bancaire ?](#1)

2 - [Quelles sont les différentes formes de découvert bancaire ?](#2)

3 - [Quelles informations doit vous communiquer la banque ?](#3)

4 - [Quels sont les frais en cas d'utilisation d'un découvert ?](#4)

5 - [Que se passe-t-il en cas de dépassement de l'autorisation de découvert ?](#5)

6 - [Comment mettre fin au découvert ?](#6)

7 - [Des outils pour vous aider](#7)
...
|
Attention, l'émission d'un chèque sans provision est toujours répréhensible : vous pouvez être inscrit |
...
> Pour en savoir plus, consultez la fiche pratique INC "[Tout savoir sur l](http://www.inc-conso.fr/content/tout-savoir-sur-le-decouvert-bancaire)[e découvert bancaire"](https://www.inc-conso.fr/content/tout-savoir-sur-le-decouvert-bancaire).
...
Il est ponctuellement et exceptionnellement accordé par votre banque qui prend l'initiative de payer un ou plusieurs chèques ou prélèvements émis alors que la provision est devenue insuffisante sur votre compte.

Attention :Sans accord écrit, ce type de découvert est risqué, puisque la banque n'est pas tenue de l'accorder et qu'elle peut rejeter les chèques et les prélèvements qui se présentent.

Notre conseil :** Il est préférable de formaliser votre découvert par un écrit**, car votre banque peut y mettre fin quand bon lui semble et sans préavis.

> Pour vous aider, consultez le modèle de lettre de l'INC "[Vous demandez un découvert occasionnel pour quelques jours](https://www.inc-conso.fr/content/vous-demandez-un-decouvert-occasionnel-pour-quelques-jours)[".](/content/banque/vous-demandez-un-decouvert-occasionnel-pour-quelques-jours)
...
> Pour en savoir plus, vous pouvez consultez la fiche pratique de l'INC ["Le prêt personnel](/content/le-pret-personnel)".
...
- En cas de modification du taux d'intérêt applicable au découvert, la banque doit
**vous informer au moins trois mois avant la date d'application**soit sur le relevé de compte, soit par une information personnalisée. A défaut d'accord, vous pouvez refuser les modifications dans les deux mois suivants l'annonce. Sinon elles sont considérées comme acceptées.
...
Les banques fixent librement le montant du taux d'intérêt (dans la limite du [taux d'usure](https://www.inc-conso.fr/content/credit)), et des frais qu'elles appliquent.

Pour en savoir plus sur le taux d'usure, visionnez la vidéo ConsoMag "[Qu'est-ce que le taux d'usure ?](https://www.inc-conso.fr/content/quest-ce-que-le-taux-de-lusure-avec-le-cnafal) " avec le CNAFAL.

- Les banques facturent souvent
**des agios forfaitaires,****c'est-à-dire un minimum forfaitaire pour toute utilisation de découvert, quelque soit son montant et sa durée.**
...
Pour connaitre [le taux d'usure](https://www.inc-conso.fr/content/credit)[.](/content/banque/credit)

Vous pouvez aussi consulter [le site de la Banque de France](http://www.banque-france.fr/statistiques/taux-et-cours/taux-dusure).

Pour en savoir plus sur le taux d'usure, visionnez la vidéo ConsoMag "[Qu'est-ce que le taux d'usure ?](/content/quest-ce-que-le-taux-de-lusure-avec-le-cnafal) " avec le CNAFAL.
...
Attention :La commission d'intervention liée au dépassement du découvert n'est pas intégrée au TAEG. Elle s'ajoutera en plus des agios.
...
Pour en savoir plus, consultez la fiche de l'INC "[L'offre spécifique clientèle fragile](https://www.inc-conso.fr/content/banque/loffre-specifique-clientele-fragile)".
...
En cas de rejet de chèque par votre banque pour provision insuffisante, vous pouvez être inscrit au [fichier central des chèques (FCC)](https://www.service-public.fr/particuliers/vosdroits/F2411), géré par la Banque de France, et vous risquez d'être interdit bancaire pendant cinq ans sur tous vos comptes, même auprès des autres banques ([voir la fiche de l'INC " le chèque](/content/banque/le-cheque)").
...
> Vous souhaitez plus d'information, consultez la fiche de l'INC "[Tout savoir sur le découvert bancaire"](https://www.inc-conso.fr/content/tout-savoir-sur-le-decouvert-bancaire).

> Vous souhaitez mieux gérer votre budget. Pour vous aider, consultez [le simulateur de l'INC "Calculez votre budget"](/content/banque/calculez-votre-budget).

> Vous êtes étudiant, consultez notre simulateur spécifique " [Calculez votre budget spécial jeunes".](/content/banque/calculez-votre-budget-special-jeunes)

> Vous pouvez aussi consulter le portail ["Mesquestionsdargent.fr"](https://www.mesquestionsdargent.fr/), onglet Budget.
