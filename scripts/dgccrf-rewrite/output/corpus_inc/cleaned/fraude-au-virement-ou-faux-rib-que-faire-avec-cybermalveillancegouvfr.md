---
date: 2024-10-15
description: 'Si, par exemple, vous recevez un mail de votre notaire ou d’un artisan
  avec lequel vous êtes en relation, et que celui-ci vous demande d’effectuer le règlement
  d’une facture dont vous devez vous acquitter par virement en utilisant le RIB joint,
  soyez très vigilant ! Derrière ce message se cache peut-être un escroc. Son but
  : détourner le virement en usurpant l’identité de votre créancier. La fraude au
  virement ou au faux RIB est souvent liée au piratage d’un compte de messagerie.'
scraped_at: '2026-02-24T23:08:39.373897'
source: https://www.inc-conso.fr/content/fraude-au-virement-ou-faux-rib-que-faire-avec-cybermalveillancegouvfr
tags:
- INC-Conso
title: 'Fraude au virement ou faux RIB : que faire ? avec Cybermalveillance.gouv.fr'
---
