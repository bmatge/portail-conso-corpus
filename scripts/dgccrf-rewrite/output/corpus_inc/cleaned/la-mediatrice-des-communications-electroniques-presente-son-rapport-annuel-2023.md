---
date: 2024-03-26
description: Madame Valérie Alvarez, Médiatrice des communications électroniques,
  a présenté, le 7 mars 2024, son rapport d'activité pour l'année 2023. Celui-ci dresse
  le bilan de l’année 2023 et fait part des diverses recommandations adressées aux
  opérateurs.  Elle présente également 7 recommandations à l’attention des consommateurs
  et 7 cas concrets soumis à la médiation des communications électroniques.
scraped_at: '2026-02-24T23:02:40.514003'
source: https://www.inc-conso.fr/content/la-mediatrice-des-communications-electroniques-presente-son-rapport-annuel-2023
tags:
- INC-Conso
...
Madame Valérie Alvarez, Médiatrice des communications électroniques, a présenté, le 7 mars 2024, son [rapport d'activité pour l'année 2023](https://rapportannuel2023.mediation-telecom.org/). Celui-ci dresse le bilan de l’année 2023 et fait part des diverses recommandations adressées aux opérateurs.

Elle présente également [7 recommandations](https://rapportannuel2023.mediation-telecom.org/recommandations.php) à l’attention des consommateurs et [7 cas concrets](https://rapportannuel2023.mediation-telecom.org/exemples.php) soumis à la médiation des communications électroniques.
...
A noter : La part dessaisines en lignes’établit à84 %en 2023 (contre 85 % en 2022). Les 16 % restants correspondent à la saisine par courrier postal.
...
A noter : La durée de traitement des dossiers a diminué en 2023 (72 jours) contre 103 en 2022. Ce délai est inférieur à lalimite des 90 joursimposé par l’[article R. 612-15 du code de la consommation], ce qui est est à souligner.
...
Les conditions et le processus permettant le recours à la médiation ne sont pas respectés (voir [processus de saisine de la Médiatrice par le consommateur](#Process)) : voies de recours non épuisées (70 %), traitement en cours auprès du service consommateurs (11 %), pas de lien contractuel (9 %), litige professionnel (4 %), hors champ de compétence (4%) et divers (1 %). Cette tendance est observée depuis 2014.
...
> Pour vous aider dans votre démarche, utilisez le modèle de lettre type de l'INC " |
