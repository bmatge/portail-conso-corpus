---
date: 2024-09-10
description: L'Autorité de contrôle prudentiel et de résolution (ACPR) alerte le public
  sur la recrudescence ces dernières semaines de fausses offres de prêt immobilier
  ou de rachat de crédit qui entrainent un risque de pertes importantes pour les victimes.
  Ces arnaques reposent dans leur grande majorité sur l’usurpation de l’identité de
  courtiers et d’établissements de crédit autorisés à exercer en France.
scraped_at: '2026-02-24T23:07:10.471808'
source: https://www.inc-conso.fr/content/lacpr-met-en-garde-contre-la-multiplication-de-fausses-offres-de-pret-immobilier-ou-de
tags:
- INC-Conso
title: L’ACPR met en garde contre la multiplication de fausses offres de prêt immobilier
  ou de rachat de crédit
---

# L’ACPR met en garde contre la multiplication de fausses offres de prêt immobilier ou de rachat de crédit
...
Par ailleurs, les escrocs utilisent de multiples noms de domaine ressemblant à ceux des établissements ou des courtiers autorisés à exercer en France (cf. annexe). A ce titre, l’ACPR publie des [listes noires](https://www.abe-infoservice.fr/liste-noire/listes-noires-et-alertes-des-autorites) recensant les noms de domaine ayant déjà été identifiés dans le cadre d’offres frauduleuses et recommande de les consulter pour vérifier que le site concerné n’y figure pas.

Si vous avez été victime, l’ACPR vous invite à [déposer une plainte](https://www.pre-plainte-en-ligne.gouv.fr/) dans les meilleurs délais.

### Pour en savoir plus :

> Consulter l'article "[Attention aux faux rachats de crédit !](https://www.abe-infoservice.fr/prevention-arnaques/savoir-detecter-une-arnaque/les-faux-produits-proposes/attention-aux-faux-rachats-de-credit)'

> Découvrir [la chaîne YouTube](https://www.youtube.com/c/AssuranceBanqueEpargneInfoService) et ses vidéos et [la chaîne SoundCloud et ses podcasts](https://soundcloud.com/abeis)

> Visiter le site : [https://acpr.banque-france.fr](https://acpr.banque-france.fr) et le site : [https://www.abe-infoservice.fr](https://www.abe-infoservice.fr)