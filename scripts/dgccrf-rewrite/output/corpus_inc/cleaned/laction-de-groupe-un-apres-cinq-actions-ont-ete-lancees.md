---
date: 2015-09-30
description: Présentée comme la mesure phare de la loi Hamon du 17 mars 2014, l'action
  de groupe permet à un groupe de consommateurs placés dans une situation similaire
  ou identique (abonnés, clients), victimes d'un manquement d'un ou des mêmes professionnels
...
scraped_at: '2026-02-24T23:39:37.474314'
source: https://www.inc-conso.fr/content/laction-de-groupe-un-apres-cinq-actions-ont-ete-lancees
tags:
- INC-Conso
title: 'L''action de groupe, un an après : cinq actions ont été lancées'
---
...
Protocole transactionnel (19 mai 2015) Selon les cas, remboursement des sommes ou déduction des charges locatives |
| Pour plus d'informations |
|
