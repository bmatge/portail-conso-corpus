---
date: 2018-02-15
description: Un nombre d’adhérents à l’AMCE ayant doublé depuis 2014L’Association
  Médiation Communications Electroniques (AMCE) regroupe, pour ce début d’année 2018,
  38 membres représentant 49 marques. Il s’agit d’opérateurs de communications électroniques
  mais aussi, par exemple, de services de renseignements téléphoniques ou d’hébergeurs
  (voir la liste complète des adhérents). Le nombre de membres a ainsi doublé depuis
  2014, date à laquelle l’AMCE ne comptait que 19 membres. Tous sont signataires de
  la charte de médiation, charte qui s’applique aussi à tout consommateur ayant recours
  à la médiation.
scraped_at: '2026-02-24T21:44:40.884992'
source: https://www.inc-conso.fr/content/le-mediateur-des-communications-electroniques-presente-son-rapport-annuel-2017
tags:
- INC-Conso
...
Madame Claire Mialaret, Médiateur des communications électroniques, a présenté, le 13 février 2018, son [rapport d’activité pour l’année 2017](http://rapportmediateur2017.mediation-telecom.org/). Celui-ci dresse le bilan de l’année passée, fait part des diverses recommandations adressées aux opérateurs et présente, à l’attention des consommateurs, dix [nouvelles fiches pratiques](http://rapportmediateur2017.mediation-telecom.org/fiches-pratiques/).

Voici quelques points significatifs de ce rapport.

### Un nombre d’adhérents à l’AMCE ayant doublé depuis 2014

L’[ Association Médiation Communications Electroniques](https://www.mediation-telecom.org/qui-sommes-nous) (AMCE) regroupe, pour ce début d’année 2018,

**38 membres**représentant 49 marques. Il s’agit d’opérateurs de communications électroniques mais aussi, par exemple, de services de renseignements téléphoniques ou d’hébergeurs (

[voir la liste complète des adhérents](https://www.mediation-telecom.org/membres)). Le nombre de membres a ainsi doublé depuis 2014, date à laquelle l’AMCE ne comptait que 19 membres.

[ charte de médiation](https://www.mediation-telecom.org/charte), charte qui s’applique aussi à tout consommateur ayant recours à la médiation.
...
**saisines en ligne** est stable passant de 63 % en 2016 à **64 %** en 2017 (l’autre partie étant réservée à l’envoi courrier).
...
> Pour savoir si le Médiateur peut traiter votre dossier, faite le [quizz](https://www.mediation-telecom.org/quizz) disponible sur le **nouveau site Internet **du Médiateur des communications électroniques.
...
**objectif des 90 jours** imposé par l’[article R. 612-5 du code de la consommation](https://www.legifrance.gouv.fr/affichCodeArticle.do;jsessionid=0466E5EF56608E86FFE188D077E6509C.tpdila17v_3?idArticle=LEGIARTI000032808336&cidTexte=LEGITEXT000006069565&dateTexte=20170426) est à souligner.

**acceptés à 95 % par les consommateurs** et à **93 % par les opérateurs** (un opérateur fait baisser la moyenne au vu de son taux d’acceptation plus faible que les autres). Ce dernier taux est en baisse par rapport à 2016 avec 97 %.
...
En 2017, [ 5 recommandations](http://rapportmediateur2017.mediation-telecom.org/recommandations-du-mediateur/) ont été émises (19 en 2016). Voici les thèmes de ces recommandations :
...
Par exemple, le Médiateur recommande aux opérateurs de respecter les dispositions prévues par l’[arrêté du 31 décembre 2013 relatif aux services de communications électroniques](https://www.legifrance.gouv.fr/affichTexte.do?cidTexte=JORFTEXT000028429711&categorieLien=id). En effet, il résulte de l’annexe, point 5 intitulé « Facture détaillée », que la facture doit comprend pour chaque communication : « a) La date et l’heure du début de communication, de la session ou l’heure d’envoi du message ».
...
|
Si vous souhaitez saisir le Médiateur des communications électroniques et que vous avez accès à Internet, utilisez de préférence la
Sinon, vous avez la possibilité, à titre exceptionnel, de saisir le médiateur par
