---
date: 2022-07-20
description: Pour l'Observatoire dont les calculs reposent sur des pourcentages par
  rapport à des volumes de transactions en hausse régulière et pour l’année 2021,
  la fraude globale aux transactions scripturales s'est élevée à 1,24 milliards d’€,
  en repli de 3,5 % pour 7,5 millions d'opérations frauduleuses soit un recul de 4,2
  %.
scraped_at: '2026-02-24T22:07:59.508753'
source: https://www.inc-conso.fr/content/le-rapport-annuel-2021-de-lobservatoire-de-la-securite-des-moyens-de-paiement-osmp-vient-de
tags:
- INC-Conso
title: Le Rapport annuel 2021 de l'Observatoire de la Sécurité des Moyens de Paiement
  (OSMP) vient de paraître
---

# Le Rapport annuel 2021 de l'Observatoire de la Sécurité des Moyens de Paiement (OSMP) vient de paraître
...
Pour l'Observatoire dont les calculs reposent sur des pourcentages par rapport à des volumes de transactions en hausse régulière et pour l’année 2021, la fraude globale aux transactions scripturales s'est élevée à 1,24 milliards d’€, en repli de 3,5 % pour 7,5 millions d'opérations frauduleuses soit un recul de 4,2 %.

L'enquête "[cadre de vie et sécurité](https://www.interieur.gouv.fr/content/download/131241/1043413/file/CVS-2021.pdf)" 2021 du service statistique ministériel de la Sécurité intérieure montre, au contraire, en nombre de ménages victimes, une évolution inverse, comme les organisations de consommateurs dont INDECOSA-CGT et les médiateurs qui voient lesrecours se multiplier (voir tableau ci-dessous).
...
**Un exemple statistique tiré du rapport annuel 2021 de la médiatrice de la FBF (fédération bancaire française)**
...
- 679 avispartiellement favorables aux consommateurs.
...
Les banques sont censées déclarer à l'ACPR (Autorité de contrôle prudentiel et de résolution) les opérations contestées dans le cadre de l'article L 133-18 et L133-19du CMF et non remboursées.

Cette autorité placée sous la tutelle du Gouverneur de la BDF (issu du groupe BNP-Paribas) n'est pas sensée gérer des litiges individuels mais la multitude de dossiers individuels devenant un vrai problème collectif susceptible d'obérer la confiance dans le système bancaire, il semble que l’ACPR travaillesur le sujet.