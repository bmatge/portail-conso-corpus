---
date: 2021-04-22
description: Les techniques pour faire varier les prix sont aujourd’hui grandement
  facilitées grâce aux nouvelles technologies, qui permettent de modifier le prix
  d’un produit ou d’une prestation quasiment instantanément et sans coût. L’Institut
  national de la consommation vous propose une liste non exhaustive des différentes
  techniques de variation des prix appliquées aujourd’hui.
scraped_at: '2026-02-24T22:03:13.096779'
source: https://www.inc-conso.fr/content/les-differentes-techniques-de-variation-des-prix
tags:
- INC-Conso
title: Les différentes techniques de variation des prix
---
...
2 – [Les discriminations tarifaires selon les catégories d’acheteurs](#categories)

3 – [Le versionning](#versionning)

5 – [La déstructuration du prix](#destructuration)

6 – [La tarification selon la logique "prime"](#prime)

7 – [La raison et les objectifs des commerçants à pratiquer des techniques de variation des prix](#raisons)

8 – [Incidences sur le comportement des consommateurs](#incidences)

9 – [L’encadrement juridique de la variation des prix](#encadrement)
...
- La fiche de l’INC sur le sujet :
[Le yield management, qu’est-ce que c’est ?](/content/le-yield-management-quest-ce-que-cest) - L’avis du Conseil national de la consommation "
[Pratiques de gestion fine des tarifs ou yield management et information des consommateurs](https://www.economie.gouv.fr/files/files/directions_services/dgccrf/boccrf/2020/20_02/AVIS-YIELD-MANAGEMENT.pdf)" - 01/2020
...
Dans le cadre juridique actuel, il n’existe pas de règles spécifiques concernant les prix personnalisés. Outre l’obligation pour les professionnels de respecter l’obligation d’affichage des prix (voir le dossier de l’INC « [L’information sur les prix ](https://www.inc-conso.fr/content/linformation-sur-les-prix-pour-certains-biens-et-services)»), l’encadrement se fait sous l’angle de l’interdiction des pratiques commerciales déloyales, tout particulièrement les pratiques commerciales trompeuses au sens de l’[article L. 121-2 du code de la consommation](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000032227297/).
...
A noter également que le Conseil national de la consommation, dans son avis de janvier 2020, a émis plusieurs préconisations d’information des consommateurs sur les prix yieldés (voir ci-dessus [point 4](#dynamique)).
...
[ici](https://www.youtube.com/watch?v=p7Hg1cMSkjc).
