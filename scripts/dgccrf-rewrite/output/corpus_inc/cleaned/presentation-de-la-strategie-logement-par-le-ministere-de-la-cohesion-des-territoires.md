---
date: 2017-09-27
description: 'Cette stratégie repose sur les constats suivants : la politique du logement
  en France ne correspond pas suffisamment aux besoins des citoyens. Il est nécessaire
  d''augmenter le nombre de logements notamment dans les zones tendues. De plus, les
  mutations technologiques et sociologiques nécessitent davantage de mobilité.'
scraped_at: '2026-02-24T23:52:09.299859'
source: https://www.inc-conso.fr/content/presentation-de-la-strategie-logement-par-le-ministere-de-la-cohesion-des-territoires
tags:
- INC-Conso
title: Présentation de la Stratégie Logement par le Ministère de la cohésion des territoires
---
...
[1er axe : Construire plus, mieux et moins cher](#1)[2ème axe : Répondre aux besoins de chacun et protéger les plus fragiles](#2)[3ème axe : Améliorer le cadre de vie](#3)
...
Pour en savoir plus : Consulter la fiche de l'INC
|
...
Pour en savoir plus : Consulter l'article de l'INC
|
...
Pour en savoir plus : Consulter la lettre type
|
...
Pour en savoir plus : Consulter les fiches de l'INC
|

**l'encadrement des loyers** ne serait pas remis en cause.
...
["SDF : objectif zéro" ](http://www.fondation-abbe-pierre.fr/sites/default/files/content-files/files/sdf_objectif_zero_-_un_plan_pour_en_finir_avec_la_vie_a_la_rue.pdf)porté par la Fondation Abbé Pierre
