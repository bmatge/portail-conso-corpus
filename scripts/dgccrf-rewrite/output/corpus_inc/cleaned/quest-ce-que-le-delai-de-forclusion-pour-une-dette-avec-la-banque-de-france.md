---
date: 2024-06-25
description: La forclusion est souvent confondue avec la prescription. Leurs effets
  sont pourtant différents. La prescription éteint une dette alors que la forclusion
  sanctionne un créancier qui n’a pas agi dans les délais pour se faire rembourser
  une dette. La forclusion s’applique donc aux dettes impayées, non réclamées à l’issue
  d’un délai fixé par la loi. Il est généralement de 2 ans, mais peut, dans certains
  cas être plus long.
scraped_at: '2026-02-24T23:05:42.446056'
source: https://www.inc-conso.fr/content/quest-ce-que-le-delai-de-forclusion-pour-une-dette-avec-la-banque-de-france
tags:
- INC-Conso
title: Qu'est-ce que le délai de forclusion pour une dette ? avec la Banque de France
---

# Qu'est-ce que le délai de forclusion pour une dette ? avec la Banque de France
...
- en payant la dette (si vous le souhaitez),
- en faisant constater la forclusion par les tribunaux,
- en déposant plainte pour appels téléphoniques abusifs.
