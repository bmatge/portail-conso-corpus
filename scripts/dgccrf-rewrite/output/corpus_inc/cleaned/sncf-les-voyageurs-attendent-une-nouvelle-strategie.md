---
date: 2019-10-15
description: 'Réseau ferré : un effort massif d’investissement est indispensableLe
  réseau ferré présente de nombreux axes et nœuds saturés, de nombreuses lignes sont
  dégradées. Il faut simultanément régénérer et moderniser le réseau classique - lignes
  transversales et "petites" lignes (voyageurs et fret) - et créer des RER urbains
  : l’ensemble du territoire doit être irrigué grâce à un maillage renforcé. Les devis
  excessifs de SNCF Réseau doivent être adaptés aux trafics attendus. Le réseau des
  lignes à grande vitesse doit être étendu, en priorité à la transversale sud.'
scraped_at: '2026-02-24T21:56:21.969369'
source: https://www.inc-conso.fr/content/sncf-les-voyageurs-attendent-une-nouvelle-strategie
tags:
- INC-Conso
title: 'SNCF : les voyageurs attendent une nouvelle stratégie'
---

# SNCF : les voyageurs attendent une nouvelle stratégie

## Communiqué de presse de la FNAUT

**- Transport**

La nomination d’un nouveau président de la SNCF doit s’accompagner de la définition d’une stratégie offensive, conforme à la fois aux besoins des voyageurs et aux intérêts financiers de l’Etat et des Régions. Cette stratégie ne doit pas être concentrée sur quelques grands axes facilement rentabilisables. Elle doit maximiser le report des trafics routiers et aériens sur le rail.
...
Les correspondances doivent être améliorées et des relations directes rétablies. La réservation obligatoire sur les trains Intercités doit être écartée. L’information et la vente des billets doivent respecter les voyageurs peu familiers avec le numérique, la suppression des points de vente doit cesser, les usagers de bonne foi sans billet ne doivent pas être pénalisés.

**L’usage du train doit redevenir simple**
...
> [Télécharger le communiqué de presse](https://fnaut.us12.list-manage.com/track/click?u=bd6b4c2fd8f5c3d84590a2e62&id=0c95c34b3d&e=0b7ed7c4c4)