---
date: 2022-04-23
description: Vous résiliez le contrat d’assurance de votre véhicule et vous souhaitez
  assurer celui-ci ou un autre auprès d’un assureur tiers ; ce dernier vous demandera
  de lui adresser une copie de votre relevé d’information. Ce document reprend les
  sinistres déclarés sur les cinq années précédant la résiliation du contrat et mentionnant
  votre part de responsabilité dans chaque sinistre. Il précise aussi le coefficient
  de réduction ou majoration (bonus-malus) et permet à ce nouvel assureur d’évaluer
  le montant de votre cotisation.
scraped_at: '2026-02-24T23:35:48.241107'
source: https://www.inc-conso.fr/content/assurance/vous-avez-resilie-votre-contrat-dassurance-auto-vous-demandez-votre-releve-dinformation
tags:
- INC-Conso
title: Vous avez résilié votre contrat d’assurance auto. Vous demandez votre relevé
  d’information
---
...
(Premier courrier) A la suite de la résiliation de mon contrat d’assurance n° (référence du contrat) couvrant le véhicule immatriculé (numéro d’immatriculation du véhicule), je vous remercie de bien vouloir m’adresser un relevé d’information sous quinzaine.
